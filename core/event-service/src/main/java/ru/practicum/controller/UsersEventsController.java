...
import ru.practicum.api.RequestFeignClient;
...
public class UsersEventsController {
    ...
    public List<ParticipationRequestDto> getRequests(@PathVariable Long userId,
        ...
        return requestFeignClient.getUsersRequestsForUserEvent(userId, eventId);
    }
    ...
    public EventRequestStatusUpdateResult getRequests(@PathVariable Long userId,
        ...
        return requestFeignClient.updateRequestStatus(userId, eventId, req);
    }
